...
select v.DistCode,V.MandCode,m.RB_Code,VillCode,v.rb_code,VillName  from Seed_Mst_Village v
inner join Seed_Mst_Mandal m on v.DistCode=m.DistCode and v.MandCode=m.MandCode
...
update Seed_Mst_Village set rb_code=1303012 where DistCode=501 AND MandCode='04'
AND VillCode='012' AND Yr='2020-21' AND Seasn='Kharif'
