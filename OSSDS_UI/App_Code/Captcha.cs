...
public class Captcha
{
    ...
    private void SetFamilyName(string familyName)
    {
        try
        {
            Font font = new Font(this.familyName, 15F);
    ...
    private void GenerateImage(string textImage)
    {
        ...
        HatchBrush hatchBrush = new HatchBrush(HatchStyle.LightHorizontal, backColor, Color.White);
    ...
    public static string generateRandomCode()
    {
        ...
        for (int i = 0; i < _charLength; i++)
            if (i % 2 == 0)
                ...
                val += Kod1[rnd.Next(Kod1.Count)].ToString();
        //if (!_caseSensitive)
        //{
        //    val = val.ToUpper();
        //}
