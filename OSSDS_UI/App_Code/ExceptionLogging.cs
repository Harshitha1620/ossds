...
public class ExceptionLogging
{
    ...
    {
        string constr = ConfigurationManager.ConnectionStrings["seedsubsidyConnectionString"].ToString();
    ...
    public static void SendExcepToDB(Exception exdb,string UserName , string IpAddress)
    {
        ...
        SqlCommand com = new SqlCommand("Seed_ExceptionLoggingToDataBase", con);
